...
const showProducts = (products) => {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h3>${product.title}</h3>
      <p style="margin-top: 24px;">Category: ${product.category}</p>
      <p>Ratings: ${product.rating.count} customers!</p>
      <h4>Average ratings: ${product.rating.rate}</h4>
      <h2>Price: $ ${product.price}</h2>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="add-to-cart-button">add to cart</button>
